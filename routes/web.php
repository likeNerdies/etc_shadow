...
//Route::prefix('/user/panel')->group(function () {//user panel route
    ...
    Route::prefix('/my-data')->group(function () {//user panel my data route
        ...
        Route::post('/address', 'Address\AddressController@store')->name('user-address');
...
Route::prefix('/search')->group(function () {
    ...
    Route::get('/ingredient/user', 'Search\SearchController@ingredientforUser')->middleware('auth')->name('search.ingredient-user');
