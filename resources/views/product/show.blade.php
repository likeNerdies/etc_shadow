                ...
                <div id="wrapper-image">
                    ...
                    <div id="wrapper-min-img" class="d-flex flex-row justify-content-between h-30 mt-2">
                        <div id="min-img-1" style="background: light" class="w-30 h-100">
                            <img id="tg-1" data-slide="0" class="w-100 h-100" src="https://images.pexels.com/photos/69731/pexels-photo-69731.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb" alt="First slide">
                        </div>

                        <div id="min-img-2" style="background: greenyellow;" class="w-30 h-100">
                            <img id="tg-2" data-slide="1" class="w-100 h-100" src="https://images.pexels.com/photos/31105/pexels-photo-31105.jpg?w=1260&h=750&auto=compress&cs=tinysrgb" alt="First slide">
                        </div>

                        <div id="min-img-3" style="background: indianred;" class="w-30 h-100">
                            <img id="tg-3" data-slide="2" class="w-100 h-100" src="https://images.pexels.com/photos/69731/pexels-photo-69731.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb" alt="First slide">
                        </div>
                    </div>
                </div>
