    ...
    <div id="main-wrapper">
        ...
        <div id="content-wrapper" class="text-center">
            ...
            <div class="container mt-5 mb-5">
                <h1 class="text-center">Fall in love with our products</h1>
            </div>

            <div style="padding:2.5%; background: linear-gradient(to bottom right, #FF6053, #FEE870);; box-shadow: 0px 4px 8px black;" class="container pb-5">
                <div style="padding:2.5%; background:rgb(240,244,243);border-radius:2.5px;" class="card-columns d-flex flex-row flex-wrap justify-content-center" id="products">
                    @foreach ($products as $product)
                        <div class="card-wrapper mx-2 mt-2">
