    ...
    <div class="col-md-6 col-12 mb-2rem">
      <div class="subscribe-info-outer-wrapper">
        <div class="subscribe-info-inner-wrapper">
          <h3 style="padding-top: 10%;" class="text-center">@lang('user/plan/subscribe.startnow') {{$plan->price}}€ !</h3>
          ...
          <p class="text-center pb-5rem"> @lang('user/plan/subscribe.can_cancel')</p>
        </div>
      </div>
    </div>
          ...
          <div>
            <form class="form-horizontal" action="">
              <div class="w-100 h-100">
                ...
                <div id="subscribe_btn" style="margin-top: 1.7rem; padding-bottom: 1.7rem;" class="d-flex justify-content-center">
                  <input type="submit" class="btn btn-mb-subscribe" value="@lang('user/plan/subscribe.start')">
                </div>
                  @else
                  <div id="subscribe_btn" style="margin-top: 1.7rem; padding-bottom: 1.7rem;" class="d-flex justify-content-center">
                    <input type="button" class="btn btn-mb-subscribe" value="@lang('user/plan/subscribe.change')">
                  </div>
                @endif
              </div>
            </form>
