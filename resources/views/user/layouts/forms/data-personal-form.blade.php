    ...
    <form class="form-horizontal" role="form" method="POST" action="{{ route('my-data-personal') }}">
        ...
        <div class="d-flex flex-md-row display-767-column mb-4">
            ...
            <div class="group-input ml-md-4 ml-sm-0">
                ...
                @if (count($errors) > 0)
                    <input id="second_surname" type="text" class="form-control col-12" name="second_surname" value="{{ old('second_surname') }}" required autofocus
                           placeholder="Second surname">
                @else
                    <input id="second_surname" type="text" class="form-control col-12" name="second_surname" value="{{ Auth::user()->second_surname }}" required
        ...
        <div class="d-flex flex-md-row display-767-column mb-4">
            ...
            <div class="group-input ml-md-4 ml-sm-0">
                ...
                @if (count($errors) > 0)
                    <input id="phone_number" type="text" class="form-control col-12" name="phone_number" value="{{ old('phone_number') }}" required autofocus
                           placeholder="Phone number">
                @else
                    <input id="phone_number" type="text" class="form-control col-12" name="phone_number" value="{{ Auth::user()->phone_number }}" required
