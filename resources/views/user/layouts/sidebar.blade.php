<div class="list-group hidden-sm-down">
    ...
    <a href="/user/panel/plan" class="list-group-item">@lang("user/profile/profile.plan")</a>
    <a href="" class="list-group-item">@lang("user/profile/profile.ingredientsAllergies")</a>
</div>
