...
@section('panel-right')
    ...
    <div class="">
        ...
        <input type="text" id="search" class="form-control" placeholder="search with id or name">
        <table class="table">
            <thead>
            <tr>
                <th>ID</th>
            ...
            @foreach ($ingredients as $ingredient)
                <tr id="ingredient{{$ingredient->id}}">
                    ...
                    <td>
                        <button class="btn btn-warning btn-xs btn-detail open-modal" value="{{$ingredient->id}}">Edit
                        </button>
                        <button class="btn btn-danger btn-xs btn-delete delete-ingredient" value="{{$ingredient->id}}">
                            Delete
                        </button>
                    </td>
                </tr>
