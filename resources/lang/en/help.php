...
return [
  ...
  "productsOption2" => "Then click the product you would like to get more information of, like the description of it,the ingredients it has, etc.",
  "productsOption3" => "",

  "ingredientsAllergies" => "How to set the ingredients you don't like and your allergies",
