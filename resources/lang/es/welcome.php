...
return [
    ...
    */
    ...
    "btnSeeProducts" => "Ver productos",
    "chooseIngAll" => "Elige los ingredientes que no te gustan y tus alergias",
    "choosePlan" => "Elige el plan que quieras",
    "gotItHome" => "¡Y lo tienes en tu dulce hogar!",

    'plans' => 'Planes',
    "subscribeToPlans" => "Suscríbete a nuestros planes",
    "subscribe" => "Suscríbete",
    "previous" => "Previo",
    "next" => "Siguiente",

    'about' => 'Quiénes somos',
    'aboutUs1Title' => "Somos una startup con una visión",
